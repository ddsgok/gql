...
func TestWithClient(t *testing.T) {
	...
	req := NewRequest(``)
	client.RunWithSpecialResp(ctx, req, nil)
...
func TestDoUseMultipartForm(t *testing.T) {
	...
	err := client.RunWithSpecialResp(ctx, &Request{q: "query {}"}, &responseData)
	is.NoErr(err)
	is.Equal(calls, 1) // calls
...
func TestDoErr(t *testing.T) {
	...
	err := client.RunWithSpecialResp(ctx, &Request{q: "query {}"}, &responseData)
	is.True(err != nil)
	is.Equal(err.Error(), "gql: Something went wrong")
}
...
func TestDoServerErr(t *testing.T) {
	...
	var responseData map[string]interface{}
	err := client.RunWithSpecialResp(ctx, &Request{q: "query {}"}, &responseData)
	is.Equal(err.Error(), "gql: server returned a non-200 status code: 500")
}
...
func TestDoBadRequestErr(t *testing.T) {
	...
	var responseData map[string]interface{}
	err := client.RunWithSpecialResp(ctx, &Request{q: "query {}"}, &responseData)
	is.Equal(err.Error(), "gql: miscellaneous message as to why the the request was bad")
}
...
func TestDoNoResponse(t *testing.T) {
	...
	ctx, cancel := context.WithTimeout(ctx, 1*time.Second)
	defer cancel()
	err := client.RunWithSpecialResp(ctx, &Request{q: "query {}"}, nil)
	is.NoErr(err)
	is.Equal(calls, 1) // calls
}
...
func TestQuery(t *testing.T) {
	...
	err := client.RunWithSpecialResp(ctx, req, &resp)
	is.NoErr(err)
	is.Equal(calls, 1)
...
func TestFile(t *testing.T) {
	...
	err := client.RunWithSpecialResp(ctx, req, nil)
	is.NoErr(err)
}
